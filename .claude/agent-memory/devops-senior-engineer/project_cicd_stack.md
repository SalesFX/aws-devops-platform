...
**Why:** Eliminates long-lived AWS credentials in GitHub; tokens are scoped to `repo:SalesFX/aws-devops-platform:ref:refs/heads/main` only.
...
- IAM role name: `devops-ia-github-actions-role`
- ECR push permissions scoped to `arn:aws:ecr:us-east-1:654654554686:repository/devops-ia/production/backend` and `.../frontend`
...
**ArgoCD:**
- `devops-ia-kubernetes/argocd-application.yaml` — Application CRD pointing to `devops-ia-kubernetes/` path, auto-sync with prune+selfHeal
